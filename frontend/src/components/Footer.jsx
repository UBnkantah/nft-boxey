...
const Footer = () => {
  return (
    // <div>
    <footer class="bg-white dark:bg-gray-900" style={{backgroundColor: "#21D4FD",
      ...
      <div class="container px-6 py-12 mx-auto">
        <div class="flex flex-wrap justify-start align-middle">
          <div class="sm:col-span-2">
            ...
            <div class="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
              ...
              <button className="w-full px-6 py-2.5 text-sm font-medium tracking-wider text-white bg-dark">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex -mx-2">
            <a
              href="#"
              class="mx-2transition-colors duration-300 text-gray-50"
              aria-label="Reddit"
            >
              <svg
